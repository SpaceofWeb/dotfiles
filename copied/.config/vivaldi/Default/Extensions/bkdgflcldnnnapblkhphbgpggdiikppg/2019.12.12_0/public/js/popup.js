...
module.exports = function (companyListMap) {
    return companyListMap.map(function (data) {
        return bel(_templateObject, data.name, data.percent, getScssClass(data.name), data.percent);
    });
...
},{"./shared/top-blocked-no-data.es6.js":60,"./top-blocked-truncated-list-items.es6.js":65,"bel":1}],67:[function(require,module,exports){
'use strict';
